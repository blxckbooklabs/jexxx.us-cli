...
export const BLXCKCHAT_HOTKEYS: readonly HotkeyDef[] = [
  ...
  { keys: "Esc", action: "Close popup · then exit", source: "codex" },
  { keys: "?", action: "Show this hotkeys overlay", source: "codex" },
  { keys: "/", action: "Slash command suggestions", source: "pi" },
  { keys: "Tab", action: "Autocomplete slash command or argument", source: "pi" },
  { keys: "↑ / ↓", action: "Input history · popup · message scroll", source: "pi" },
  { keys: "PgUp / PgDn", action: "Scroll message area by page", source: "opencode" },
  { keys: "Home / End", action: "Jump to top / bottom of messages", source: "opencode" },
  { keys: "Ctrl+G", action: "Jump to latest message", source: "opencode" },
