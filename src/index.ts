...
function requireOperatorClient() {
  ...
  return createOperatorClient(env);
}
...
program
  .command('doctor')
  .description('Verify operator credentials and MAMAbase connectivity without writing data')
  .action(async () => {
...
program
  ...
  .action(async (file, options) => {
    ...
    const supabase = requireOperatorClient();
